<template>
  <a
    ...
    href="#"
  >
    <logo-mobile class="logo__mobile"></logo-mobile>
    <logo-name class="logo__name"></logo-name>
    <logo-tablet class="logo__tablet"></logo-tablet>
    <logo-desktop class="logo__desktop"></logo-desktop>
  </a>
</template>
